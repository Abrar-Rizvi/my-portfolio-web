...
const Feature = () => {
  return (
    ...
    <div id="cards" className=' mt-[50px] flex flex-col space-y-10 '>
     
        {cards.map((card, idx) => {
          return <div key={idx} className="card-of-image-description group w-full lg:w-[60%] xl:w-[80%] space-y-10  shadow-lg mx-auto hover:scale-110 transition-all  ease-in-out duration-700  ">
